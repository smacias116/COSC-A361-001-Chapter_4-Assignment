...
//  GO TO LINE 392 TO CHANGE INPUT FILE
//------------------------------------------------------------
...
void lex();     // <------------------------ADDING HERE TO DECLARE THE FUNCTION
void term();    // <------------------------ADDING HERE TO DECLARE THE FUNCTION
void factor();  // <------------------------ADDING HERE TO DECLARE THE FUNCTION
...
//#include <string>     // <------------------------INCLUDED ABOVE
//using namespace std;  // <------------------------INCLUDED ABOVE
...
int ind = 0;    // index to top of symbol table
                        // <------------------------NOTE: variable name from "index" to "ind" (index reserved in standard C library)
...
//void expr();          // <------------------------INCLUDED ABOVE (befre Global variables)
//void term();          // <------------------------NOT NEDDED
//void factor();        // <------------------------INCLUDED ABOVE (befre Global variables)
...
// assign() Parses assignment statement by the rule:
...
// initializeVar () Parses integer variable by the rule:
...
// intVar() integer identifier (variable) parser by the rule:
...
// declaration() Parses declaration statement by the rule
...
//#include <iostream>           // <------------------------INCLUDED ABOVE 
//#include <fstream>            // <------------------------INCLUDED ABOVE 
//#include <cstdlib>            // <------------------------INCLUDED ABOVE 
//#include "globalVars.cpp"     // <------------------------WRONG NAME (typo in Class Slides)
//#include "Globals.cpp"        // <------------------------NOT NEDDED (files together in this myCompiler.cpp)
//#include "symbolTable.cpp"    // <------------------------NOT NEDDED (files together in this myCompiler.cpp)
//#include "bnf.cpp"            // <------------------------NOT NEDDED (files together in this myCompiler.cpp)
//using namespace std;          // <------------------------INCLUDED ABOVE

ifstream infp;
// const int MAX_SIZE = 100;   // maximum size per line    // <------------------------NOT NEDDED (already declared in Global variables)           
...
{
    string filename;
    filename = "prg2.in"; // <------------------------CHANGE INPUT FILE
    infp.open(filename);
